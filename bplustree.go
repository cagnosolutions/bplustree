...
func non_leaf_insert(tree *bplus_tree, node *bplus_non_leaf, sub_node *bplus_node, int key, int level) int {
...
func bplus_tree_insert(tree *bplus_tree, key int, key, data int) int {
